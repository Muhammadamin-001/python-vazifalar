        ...
        if fikri=='ha':
            ...
            while ishora:
                ...
                if natija=='t':
                    ...
                    belg2=taxmini-1 #minimal chegara taxmindan bittaga oshiriladi.
                    taxmini=r.randint(belg1, belg2)
                    
                elif natija=='+': #Son taxminidan katta bo'lsa,
                    belg1=taxmini+1 #taxmindan bitta kichik songa tushiriladi.
                    taxmini=r.randint(belg1, belg2)
            ...
            if count<c:
                print("siz({count}) g'olib!")
            elif count==c:
                print("kuchlar teng!")
            else:
                print("siz yaxshi o'ynadingiz({count}), lekin ustunlik menda..!")
        print("\n")
    else:
        loyiha=False
